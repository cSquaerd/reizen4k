...
\begin{document}
	...
	\begin{FlushLeft}
		...
		\begin{multicols}{2}
			...
			and, worst of all, certain "cursed" locations remain hotbeds for daemon interlopers, extra-dimensional aberrations that seek to kill or consume everything in their path. \vfill \pagebreak
			...
			\begin{itemize}[wide]
				...
				\begin{itemize}
					...
					All damage done to Daemonkind, Dragons, and other mighty beasts gains +4 overall.
					This increases by +1 every level hereafter
				\end{itemize}
			\end{itemize}
			...
			\begin{itemize}[wide]
				...
				\begin{itemize}
					...
					This can only be done outside of combat
				\end{itemize}
			\end{itemize}
			\vfill \pagebreak
			...
			\begin{itemize}[wide]
				...
				\begin{itemize}
					...
					This increases by +1 every other level hereafter
			...
			\begin{itemize}[wide]
				...
				\begin{itemize}
					...
					Cybernetic Arms and Legs' bonuses also each gain +1 to their ability scores.
			...
			\begin{itemize}[wide]
				...
				\begin{itemize}
					...
					When in wooded or rural areas, gain +1 to all ability scores and general advantage in combat
